...
const CoordinatorEvents = (params) => {
    ...
    const eventInfo = (event) => {
          navigate({
            pathname: '/volunteer/event/data/acceess-valid',
        ...
        (async()=>{
            try {
                const response = await axios({
                    method: 'get',
                    url: 'http://localhost:1008/volunteer/events/coordinating',
                    credentials: true,
                    params: {
